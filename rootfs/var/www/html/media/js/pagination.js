    ...
    var obj = function (el, options) {
        ...
        if (options) {
            ...
            this.pageSizeOptions =
                options.pageSizeOptions || this.pageSizeOptions
    ...
    obj.prototype = {
        ...
        _handlePageJump: function (element) {
            ...
            if (element.classList.contains('first')) {
                pageFirstMore.attr(
                    'p_index',
                    Math.max(1, parseInt(pageFirstMore.attr('p_index')) - 5),
                )
                pageLastMore.attr(
                    'p_index',
                    Math.min(
                        this.pageCount,
                        parseInt(pageLastMore.attr('p_index')) - 5,
                    ),
                )
            }
        ...
        _bindEvent: function () {
            ...
            var pageJumperEl = $(this.container).find(
        ...
        _getShowIndex: function (index) {
            ...
            const pageFirstMoreIndex = parseInt(
                (pageFirstMore[0] &&
                    pageFirstMore[0].getAttribute('p_index')) ||
                    1,
            )
            const pageLastMoreIndex = parseInt(
                (pageLastMore[0] && pageLastMore[0].getAttribute('p_index')) ||
                    this.pageCount,
            )

            const centerPageIndex = Math.floor(
                (pageLastMoreIndex + pageFirstMoreIndex) / 2,
            )
